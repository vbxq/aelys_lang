...
impl CompilerStage {
    pub fn new() -> Self {
        Self { module_aliases: HashSet::new(), known_globals: HashSet::new(), known_native_globals: HashSet::new() }
    }

    pub fn with_modules(module_aliases: HashSet<String>, known_globals: HashSet<String>, known_native_globals: HashSet<String>) -> Self {
        Self { module_aliases, known_globals, known_native_globals }
    }
}
