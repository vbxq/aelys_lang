...
static MODULE_NAME: &[u8] = b"hot_mod\0";
static MODULE_VERSION: &[u8] = b"0.1.0\0";
static EXPORT_NAME: &[u8] = b"value\0";
static EXTRA_NAME: &[u8] = b"extra\0";

extern "C" fn hot_value(
    _vm: *mut c_void,
...
static EXPORTS: [AelysExport; 2] = [
    AelysExport {
        ...
        arity: 0,
        _padding: [0; 3],
        value: hot_value as *const c_void,
    },
    AelysExport {
        name: EXTRA_NAME.as_ptr() as *const i8,
        kind: AelysExportKind::Function,
        arity: 0,
        _padding: [0; 3],
        value: hot_extra as *const c_void,
    },
];
